...
class HandleButtons(object):
    ...
    def process(self):
        options = defaultdict(lambda: self.exit, {
            'stats_ride': self.stats_ride,
            'stats_ride_all_time': self.stats_ride_all_time,
            'stats_ride_ytd': self.stats_ride_ytd,
            'stats_ride_misc': self.stats_ride_misc,
            'stats_run': self.stats_run,
            'stats_run_all_time': self.stats_run_all_time,
            'stats_run_ytd': self.stats_run_ytd,
            'back': self.back,
            'exit': self.exit,
        })
