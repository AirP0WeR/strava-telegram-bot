...
class BotConstants(object):
    ...
    MESSAGE_SHOULD_UPDATE_INDOOR_RIDE_DISABLE = "You have automated update of Indoor Rides. Do you want to disable it?"
    ...
    MESSAGE_AUTO_UPDATE_INDOOR_RIDE_CONFIRMATION = "Are you sure you want to enable auto updates of Indoor Rides?"
